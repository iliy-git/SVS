...
new  class extends Component {
    public $clientId, $name, $phone, $address, $additional_info, $telegram_id;
                ...
                <form wire:submit.prevent="save">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" wire:model="telegram_id" class="form-control bg-light border-0" placeholder="111111111">
                        </div>
                        <div class="col-md-6">
