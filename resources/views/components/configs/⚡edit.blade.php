...
new class extends Component {
    ...
    public function mount($clientId, $subId, $configId, ConfigService $service)
    {
        $this->clientId = $clientId;
        $this->subId = $subId;
        $this->flags = $service->getAllFlags();

        $this->fill($service->getFormData($configId));
    }

    public function save(ConfigService $service)
    {
        $validated = $service->validate($this->all(), $this->configId);

        $service->updateConfig($this->configId, $validated);
